...
export class StreamUploader {
    ...
    public start(): void {
        if (this.videoRecorder && this.audioRecorder && this.screenRecorder) {
            this.videoRecorder.start(2000); // Record video in chunks of 2 seconds
            this.audioRecorder.start(2000); // Record audio in chunks of 2 seconds
            this.screenRecorder.start(2000); // Record screen in chunks of 2 seconds
        } else {
